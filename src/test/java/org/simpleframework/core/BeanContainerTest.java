...
public class BeanContainerTest {
    ...
    @Order(1)
    @DisplayName("加载ioc容器：loadBeanTest")
    @Test
    ...
    @DisplayName("根据类对象获取其实例：getBeanTest()")
    @Order(2)
    @Test
    ...
    @DisplayName("根据注解获取类对象：getClassesByAnnotationTest")
    @Order(3)
    @Test
    ...
    @DisplayName("根据接口获取实现类的类对象：getClassesBySuperTestgetClassesBySuperTest()")
    @Order(4)
    @Test
